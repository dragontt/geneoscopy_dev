...
DIR_DATA=/Users/KANG/geneoscopy_dev/data/run_proj_abcdefgh_2
NUM_SAMPLES=177
GROUP=N_vs_P_vs_C
...
SAMPLE_SHEET=${DIR_DATA}/sample_sheet_combined_abcdefgh.txt
...
# THLD_PVALS=( 0.035 0.038 0.039 0.04 0.041 0.42 0.45 )
THLD_PVALS=( 0.04 )
